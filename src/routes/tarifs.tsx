...
const plans = [
  {
    ...
    desc: "Modifications, ajout de fonctionnalités sur un site déjà livré.",
  ...
  },
  {
    ...
    desc: "Design sur mesure, gestion produits & commandes, WhatsApp, dashboard. Livré en 3 jours.",
    cta: "Démarrer mon site",
    highlight: true,
    badge: "Offre principale",
  },
  {
    name: "Support 30 jours",
    price: "0 DH · Inclus",
    desc: "Corrections, accompagnement WhatsApp, maintenance gratuite pour lancer sereinement.",
    cta: "En savoir plus",
    highlight: false,
  },
];
